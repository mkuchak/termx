...
android {
    ...
    // Robolectric runs the JVM unit tests against real Android APIs —
    // used here to exercise the SshSessionClient → TerminalView repaint
    // handoff without spinning up a connected-device test.
    testOptions {
